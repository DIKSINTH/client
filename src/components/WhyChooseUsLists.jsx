...
const API_URL = "http://localhost:5000/api/why-choose-us-list";
...
const ChooseUsCard = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      {/* Name */}
      <h3 className="text-lg md:text-xl font-semibold text-gray-800 mb-3 transition-colors duration-300 hover:text-indigo-600">
        {item.name}
      </h3>
