...
const API_URL = "http://localhost:5000/api/web-maintenance-design-lists";
...
const ValueCircle = ({ text, index }) => {
  ...
  return (
    ...
    >
      <div className="w-36 h-36 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full cady flex items-center justify-center text-center p-4 shadow-xl">
