      ...
      <div className="min-h-screen bg-[#F8FAFC] p-6 lg:p-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
            <div>
              <button
                onClick={() => navigate("/dashboard/view-logodesign")}
              ...
              <h1 className="text-3xl font-bold text-slate-800 tracking-tight">
                Edit Service:{" "}
                <span className="text-indigo-600">Logo Design</span>
              </h1>
            </div>
            <button
              form="main-form"
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100">
                <div className="flex items-center gap-2 mb-6 text-slate-800">
                  ...
                  <h2 className="font-bold">Process & Additional Fields</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {Object.keys(form)
                    ...
                    .map((key) => (
                      <div key={key}>
                        <label className="text-[10px] font-bold text-slate-400 uppercase mb-1 block truncate">
                          {key.replace(/_/g, " ")}
                        </label>
                        <input
                          type="text"
            ...
            <div className="space-y-8">
              <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100">
                ...
                <div className="relative group border-2 border-dashed border-slate-200 rounded-2xl p-4 text-center hover:border-indigo-400 transition-colors bg-slate-50">
                  {preview ? (
                    ...
                    <div className="aspect-video flex items-center justify-center text-slate-300 bg-white rounded-xl mb-4">
                      <FiUploadCloud size={40} />
                    </div>
                  )}
                  <label className="inline-flex items-center gap-2 bg-white text-indigo-600 px-4 py-2 rounded-lg text-xs font-bold shadow-sm border border-slate-100 cursor-pointer hover:bg-indigo-50 transition-all">
              ...
              <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full bg-slate-50 border border-slate-100 p-4 rounded-xl text-sm italic"
