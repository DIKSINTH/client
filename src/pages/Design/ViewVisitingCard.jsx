...
export default function ViewVisitingCard() {
          ...
          <div className="flex justify-between items-end mb-8 border-b border-slate-200 pb-6">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1 font-medium">
                Manage and preview your professional card service.
              </p>
            </div>
            <Link
              to="/dashboard/view-visitingcard/edit"
                  ...
                  <div className="relative group w-full flex justify-center">
                    {data.Image ? (
                      ...
                      <div className="w-64 h-40 bg-white rounded-2xl border-2 border-dashed border-slate-300 flex flex-col items-center justify-center text-slate-400">
                        <FiCreditCard size={40} className="mb-2 opacity-20" />
